...
class GameRunService:
    def __init__(self,repository:GameV2Repository,beliefs:BeliefLifecycleService,*,now_fn:Callable[[],float]=time.time)->None:
        self.repository=repository;self.beliefs=beliefs;self.now_fn=now_fn;self.last_resolution={};self.resolution_latencies=[];self.compatibility={"legacy_progress":[],"legacy_run":[],"shadow_diffs":[]}
