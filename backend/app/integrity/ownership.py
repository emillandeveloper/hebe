...
OWNERSHIP = [
 ...
 ("game knowledge/research/guidance","GameContextResolver","none"),("Game mutable run state","GameRunService","none"),("GameRunState","GameRunService","runtime projection"),("Game knowledge","GameKnowledgeV2Service","none"),
 ("social identity/presence/summaries","SocialWorldService","none"),("legacy chatter profiles/presence/facts/summaries","versioned Social migrations","historical archive only"),("SocialWorld","SocialWorldService","none"),("SharedCulture","SocialWorldService","none"),("persona identity/voice","StableHebeCore","none"),
